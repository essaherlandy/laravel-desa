                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                <form action="{{route('dashboard.admin.perangkat.perangkat-update',$perangkat->id)}}" method="post">
                                    {{csrf_field()}}
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_jabatan" id="id_jabatan" class="form-control input-md" required>
                                                ...
                                                <option value="{{$jb->id}}" <?=($jb->id == $perangkat->id_jabatan ? 'selected' : null)?>>{{$jb->deskripsi}}</option>
                                                @endforeach
                                            </select> 
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label" for="Status1">
                                                <input class="form-check-input" type="radio" name="is_active" id="Status1" value="Y" {{ $perangkat->is_active == 'Y' ? 'checked' : '' }}>
                                                Aktif
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <label class="form-check-label" for="Status2">
                                                <input class="form-check-input" type="radio" name="is_active" id="Status2" value="N" {{ $perangkat->is_active == 'N' ? 'checked' : '' }}>
                                                Tidak Aktif
                                            </label>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="nip" type="text" class="form-control input-md ui-autocomplete-input" value="{{$perangkat->nip}}">
                                            <span class="help-block"></span>  
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="niap" type="text" class="form-control input-md ui-autocomplete-input" value="{{$perangkat->niap}}">
                                            <span class="help-block"></span>  
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_pangkat_gol" id="id_pangkat_gol" class="form-control input-md" required>
                                                ...
                                                <option value="{{$pangkat->id}}" <?=($pangkat->id == $perangkat->id_pangkat_gol ? 'selected' : null)?>>{{$pangkat->deskripsi}}</option>
                                                @endforeach
                                            </select> 
                                            <span class="help-block"></span>  
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="no_sk_angkat" type="text" class="form-control input-md ui-autocomplete-input" value="{{$perangkat->no_sk_angkat}}">
                                            <span class="help-block"></span>  
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    <label class="col-md-3 control-label" for="tgl_hpl">Tanggal Angkat</label>  
                                        <div class="input-group mb-2 col-md-6">
                                            ...
                                            <input name="tgl_angkat" type="text" class="datepicker form-control" autocomplete="off" value="{{$perangkat->tgl_angkat}}">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="nama">No. SK Berhenti</label>  
                                        <div class="col-md-9">
                                            <input name="no_sk_berhenti" type="text" class="form-control input-md ui-autocomplete-input" value="{{$perangkat->no_sk_berhenti}}">
                                            <span class="help-block"></span>  
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    <label class="col-md-3 control-label" for="tgl_hpl">Tanggal Berhenti</label>  
                                        <div class="input-group mb-2 col-md-6">
                                            ...
                                            <input name="tgl_berhenti" type="text" class="datepicker form-control" autocomplete="off" value="{{$perangkat->tgl_berhenti}}">
                                        </div>
                                    </div>
