                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <table id="row-select"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{formatted_price($produk->harga)}}</td>
                                                        <td><img src="{{$produk->gambar}}" style="width:150px;heitgh:150px;"></td>
                                                        <td>{!!$produk->deskripsi!!}</td>
                                                        <td>
                                                            <a href="{{route('dashboard.admin.edit-produk-olahan',$produk->id)}}" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>

                                                            <a type="button" class="btn btn-danger btn-sm" data-toggle="modal" data-target="#hapusProduk{{$produk->id}}"><i class="fa fa-trash"></i></a>
                                                            <!-- Modal -->
                                                            <div class="modal fade" id="hapusProduk{{$produk->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-body">
                                                                            <form action="{{route('dashboard.admin.produk-olahan-delete',$produk->id)}}" method="get" enctype="multipart/form-data">
                                                                                {{csrf_field()}}
                                                                                <h4 class="text-center"><b>Apakah Anda Yakin Ingin Menghapus Data dengan nama <br>{{$produk->judul_produk}}??</b></h4>
                                                                            </div>
                                                ...
                                                <a>Total Keseluruhan: <b>{{ $produks->total() }}</b></a>
...
<div class="modal fade" id="tambahPengguna" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.admin.produk-olahan-store')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-group">
                        <label>Judul Produk</label>
                        <input type="text" name="judul_produk" class="form-control" value="{{ old('judul_produk') }}">
                    </div>
                    <div class="form-group">
