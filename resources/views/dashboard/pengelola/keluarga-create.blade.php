                            ...
                            <div class="card-block p-b-0">
                                <div class="container">
                                    <div class="table-responsive">
                                        <form action="{{route('dashboard.pengelola.keluarga-store')}}" method="POST" enctype="multipart/form-data">
                                            {{csrf_field()}}
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_agama" id="id_agama" class="form-control input-md">
                                                    ...
                                                    @foreach($agama as $agamas)
                                                        <option value="{{$agamas->id}}" {{ old('id_agama') == $agamas->id ? 'selected' : '' }}>{{$agamas->deskripsi}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_goldar" id="id_goldar" class="form-control input-md">
                                                    ...
                                                    @foreach($golonganDarah as $goldar)
                                                        <option value="{{$goldar->id}}" {{ old('id_goldar') == $goldar->id ? 'selected' : '' }}>{{$goldar->deskripsi}}</option>
                                                    @endforeach
                                                </select>   
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_pendidikan" id="id_goldar" class="form-control input-md">
                                                    ...
                                                    @foreach($pendidikans as $pendidikan)
                                                        <option value="{{$pendidikan->id}}" {{ old('id_pendidikan') == $pendidikan->id ? 'selected' : '' }}>{{$pendidikan->deskripsi}}</option>
                                                    @endforeach
                                                </select>     
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_pendidikan_terakhir" id="id_goldar" class="form-control input-md">
                                                    ...
                                                    @foreach($pendidikans as $terakhir)
                                                        <option value="{{$terakhir->id}}" {{ old('id_pendidikan_terakhir') == $terakhir->id ? 'selected' : '' }}>{{$terakhir->deskripsi}}</option>
                                                    @endforeach
                                                </select>    
                                            ...
                                            <div class="form-group row">
                                                <div class="col">
                                                    ...
                                                    <select name="id_pekerjaan" id="id_goldar" class="form-control input-md">
                                                        ...
                                                        <option value="{{$pekerjaan->id}}" {{ old('id_pekerjaan') == $pekerjaan->id ? 'selected' : '' }}>{{$pekerjaan->deskripsi}}</option>
                                                        @endforeach
                                                    </select>  
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select name="id_pekerjaan_penduduk" id="" class="form-control input-md">
                                                        ...
                                                        <option value="{{$penduduks->id}}" {{ old('id_pekerjaan_penduduk') == $penduduks->id ? 'selected' : '' }}>{{$penduduks->deskripsi}}</option>
                                                        @endforeach
                                                    </select>  
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_kewarganegaraan" class="form-control">
                                                    ...
                                                    <option value="{{$kewarganegara->id}}" {{ old('id_kewarganegaraan') == $kewarganegara->id ? 'selected' : '' }}>{{$kewarganegara->deskripsi}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_kompetensi" id="id_agama" class="form-control input-md">
                                                    ...
                                                    <option value="{{$kompeten->id}}" {{ old('id_kompetensi') == $kompeten->id ? 'selected' : '' }}>{{$kompeten->deskripsi}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_status_kawin" id="id_agama" class="form-control input-md">
                                                    ...
                                                    <option value="{{$statusKawin->id}}" {{ old('id_status_kawin') == $statusKawin->id ? 'selected' : '' }}>{{$statusKawin->deskripsi}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_status_penduduk" id="id_agama" class="form-control input-md">
                                                    ...
                                                    <option value="{{$statusPenduduk->id}}" {{ old('id_status_penduduk') == $statusPenduduk->id ? 'selected' : '' }}>{{$statusPenduduk->deskripsi}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="id_status_tinggal" id="id_agama" class="form-control input-md">
                                                    ...
                                                    <option value="{{$statusTinggal->id}}" {{ old('id_status_tinggal') == $statusTinggal->id ? 'selected' : '' }}>{{$statusTinggal->deskripsi}}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group row">
                                                <div class="col">
                                                    ...
                                                    <select name="id_difabilitas" id="id_goldar" class="form-control input-md">
                                                        ...
                                                        <option value="{{$difabi->id}}" {{ old('id_difabilitas') == $difabi->id ? 'selected' : '' }}>{{$difabi->deskripsi}}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <label for="">Kontrasepsi</label>
                                                    <select name="id_kontrasepsi" id="id_goldar" class="form-control input-md">
                                                        ...
                                                        <option value="{{$kontra->id}}" {{ old('id_kontrasepsi') == $kontra->id ? 'selected' : '' }}>{{$kontra->deskripsi}}</option>
                                                        @endforeach
                                                    </select>  
