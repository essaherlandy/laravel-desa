                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <h3>Tambah GIZI BURUK</h3>
                            </div>

                            <div class="card-block">
                                <form action="{{route('dashboard.pengelola.kesehatan.gizi-buruk-store')}}" method="post">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="nama">Berat Badan</label>  
                                        <div class="col-md-9">
                                            <input id="" name="berat_badan" type="text" class="form-control input-md ui-autocomplete-input" autocomplete="off">
                                            <span class="help-block"></span>  
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="nama">Tinggi Badan</label>  
                                        <div class="col-md-9">
                                            <input id="" name="tinggi_badan" type="text" class="form-control input-md ui-autocomplete-input" autocomplete="off">
                                            <span class="help-block"></span>  
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    <label class="col-md-3 control-label" for="tgl_hpl">Tanggal Menimbang</label>  
                                        <div class="input-group mb-2 col-md-6">
                                            <div class="input-group-prepend">
                                            <div class="input-group-text"><i class="fa fa-table"></i></div>
                                            </div>
                                            <input name="tgl_timbang" type="text" class="datepicker form-control">
                                        </div>
                                    </div>
    ...
    var CSRF_TOKEN = $('meta[name="csrf-token"]').attr('content');
        $(document).ready(function(){
            $( "#penduduk_search" ).autocomplete({
                ...
                $.ajax({
                    url:"{{route('dashboard.pengelola.kesehatan.get-gizi-buruk')}}",
                    type: 'post',
                    dataType: "json",
                    data: {
                        _token: CSRF_TOKEN,
