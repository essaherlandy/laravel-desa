                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <button class="btn waves-effect waves-light hor-grd btn-grd-primary btn-sm mb-3"
                                    data-toggle="modal" data-target="#tambahkompetensis"> <i class="fa fa-plus"></i>
                                    Tambah</button>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12">
                                                <table id="row-select"
                                                    ...
                                                    <tr>
                                                        <td>{{$index + $kompetensis->firstItem()}}</td>
                                                        <td>{{$kompetensi->deskripsi}}</td>
                                                        <td>
                                                        <a class="btn btn-warning btn-sm text-white mb-3"
                                                            data-toggle="modal" data-target="#editkompetensis{{$kompetensi->id}}"> <i class="fa fa-edit"></i></a>
                                                        <!-- Modal -->
                                                            <div class="modal fade" id="editkompetensis{{$kompetensi->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="{{route('dashboard.pengelola.kompetensi-update',$kompetensi->id)}}" method="POST" enctype="multipart/form-data">
                                                                                {{csrf_field()}}
                                                                                <div class="form-group">
                                                                                    <label>Deskripsi</label>
                                                                                    <input name="deskripsi" type="text" class="form-control" value="{{ $kompetensi->deskripsi }}">
                                                                                </div>
                                                                        </div>
                                                            ...
                                                            data-toggle="modal" data-target="#hapuskompetensis{{$kompetensi->id}}"> <i class="fa fa-trash"></i></a>
                                                        <!-- Modal -->
                                                            <div class="modal fade" id="hapuskompetensis{{$kompetensi->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="{{route('dashboard.pengelola.kompetensi-delete',$kompetensi->id)}}" method="GET" enctype="multipart/form-data">
                                                                                {{csrf_field()}}
                                                ...
                                                <a>Total Keseluruhan: <b>{{ $kompetensis->total() }}</b></a>
                                                {{$kompetensis->appends(request()->query())->links()}}
                                            </div>
                                        </div>
                                        @else
                                        <br>
...
<!-- Modal -->
<div class="modal fade" id="tambahkompetensis" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.pengelola.kompetensi-store')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-group">
                        <label>Deskripsi</label>
