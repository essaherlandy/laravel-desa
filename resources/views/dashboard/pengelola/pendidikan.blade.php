                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <button class="btn waves-effect waves-light hor-grd btn-grd-primary btn-sm mb-3"
                                    data-toggle="modal" data-target="#tambahPendidikan"> <i class="fa fa-plus"></i>
                                    Tambah</button>
                                            ...
                                            <div class="col-xs-12 col-sm-12">
                                                <table id="row-select"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>{{$pend->deskripsi}}</td>
                                                        <td>
                                                            <a class="btn btn-warning btn-sm text-white mb-3"
                                                            data-toggle="modal" data-target="#editPendidikan{{$pend->id}}"> <i class="fa fa-edit"></i></a>
                                                        <!-- Modal -->
                                                            <div class="modal fade" id="editPendidikan{{$pend->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog modal-lg" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="{{route('dashboard.pengelola.pendidikan-update',$pend->id)}}" method="POST" enctype="multipart/form-data">
                                                                                {{csrf_field()}}
                                                                                <div class="form-group">
                                                                                    <label>Deskripsi</label>
                                                                                    <input name="deskripsi" type="text" class="form-control" value="{{ $pend->deskripsi }}">
                                                                                </div>
                                                                        </div>
                                                        ...
                                                        <a class="btn btn-danger btn-sm text-white mb-3"
                                                            data-toggle="modal" data-target="#hapusPendidikan{{$pend->id}}"> <i class="fa fa-trash"></i></a>
                                                            <!-- Modal -->
                                                            <div class="modal fade" id="hapusPendidikan{{$pend->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="{{route('dashboard.pengelola.pendidikan-delete',$pend->id)}}" method="GET" enctype="multipart/form-data">
                                                                                {{csrf_field()}}
                                                ...
                                                <a>Total Keseluruhan: <b>{{ $pendidikan->total() }}</b></a>
                                                {{$pendidikan->appends(request()->query())->links()}}
                                            </div>
                                        </div>
                                        @else
                                        <br>
...
<!-- Modal -->
<div class="modal fade" id="tambahPendidikan" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.pengelola.pendidikan-store')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-group">
                        <label>Deskripsi</label>
