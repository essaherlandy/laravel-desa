                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                <form action="{{route('dashboard.pengelola.perangkat.perangkat-store')}}" method="post">
                                    {{csrf_field()}}
                                    <h4 class="mt-3">Data Kematian Penduduk</h4>
                                    <hr>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label" for="nik_nama">Pencarian Data Perangkat Desa</label>  
                                        <div class="col-md-9">
