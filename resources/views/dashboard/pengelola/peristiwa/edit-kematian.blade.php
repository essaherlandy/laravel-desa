                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                <form action="{{route('dashboard.pengelola.peristiwa.kematian-update',$kematians->id)}}" method="post">
                                    {{csrf_field()}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="sebab" type="text" class="form-control" value="{{$kematians->sebab}}">
                                            <span class="help-block"></span>  
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="penentu_kematian" type="text" class="form-control" value="{{$kematians->penentu_kematian}}">
                                            <span class="help-block"></span>  
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="tempat_kematian" type="text" class="form-control" value="{{$kematians->tempat_kematian}}">
                                            <span class="help-block"></span>  
                                        </div>
                                    </div>
                                    <br>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input name="nama_pelapor" type="text" class="form-control" value="{{$kematians->nama_pelapor}}">
                                            <span class="help-block"></span>  
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <select name="id_pelapor" class="form-control">
                                                ...
                                                @foreach($pelapor as $pel)
                                                    <option value="{{$pel->id}}" <?=($pel->id == $kematians->id_pelapor ? 'selected' : null)?>>{{$pel->deskripsi}}</option>
                                                @endforeach
                                            </select>  
                                        </div>
                                    </div>
