                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                                ...
                                <button class="btn waves-effect waves-light hor-grd btn-grd-primary btn-sm mb-3"
                                    data-toggle="modal" data-target="#tambahjbtn"> <i class="fa fa-plus"></i>
                                    Tambah</button>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12">
                                                <table id="row-select"
                                                    ...
                                                    <tbody>
                                                    <?php $no=1;?>
                                                    @foreach($jabatans as $index => $jbtn)
                                                    <tr>
                                                        <td>{{$index + $jabatans->firstItem()}}</td>
                                                        <td>{{$jbtn->deskripsi}}</td>
                                                        <td>
                                                        <a class="btn btn-warning btn-sm text-white mb-3"
                                                            data-toggle="modal" data-target="#editjabatans{{$jbtn->id}}"> <i class="fa fa-edit"></i></a>
                                                        <!-- Modal -->
                                                            <div class="modal fade" id="editjabatans{{$jbtn->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="{{route('dashboard.pengelola.pustakalainnya.jabatan-update',$jbtn->id)}}" method="POST" enctype="multipart/form-data">
                                                                                {{csrf_field()}}
                                                                                <div class="form-group">
                                                                                    <label>Deskripsi</label>
                                                                                    <input name="deskripsi" type="text" class="form-control" value="{{ $jbtn->deskripsi }}">
                                                                                </div>
                                                                        </div>
                                                            ...
                                                            data-toggle="modal" data-target="#hapusjbtn{{$jbtn->id}}"> <i class="fa fa-trash"></i></a>
                                                        <!-- Modal -->
                                                            <div class="modal fade" id="hapusjbtn{{$jbtn->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                                                                aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <form action="{{route('dashboard.pengelola.pustakalainnya.jabatan-delete',$jbtn->id)}}" method="GET" enctype="multipart/form-data">
                                                                                {{csrf_field()}}
                                                ...
                                                <a>Total Keseluruhan: <b>{{ $jabatans->total() }}</b></a>
...
<!-- Modal -->
<div class="modal fade" id="tambahjbtn" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form action="{{route('dashboard.pengelola.pustakalainnya.jabatan-store')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-group">
                        <label>Deskripsi</label>
